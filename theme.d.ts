...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures__invoke2_mut__hd9e8d0ab6c423147: (a: number, b: number, c: number, d: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__h4ff2ab9a74032dc3: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures__invoke1_mut__h7cf024f3b3a4652e: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke1_mut__h20b5904d7ac64dbe: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__h277d90e138fe83fc: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__h90b86ec4af6afa4c: (a: number, b: number) => void;
